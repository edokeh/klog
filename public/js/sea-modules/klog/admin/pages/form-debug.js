 ...
 * 页面编辑表单
 */
define("klog/admin/pages/form-debug", [ "../common/markdown-editor-debug", "../common/attach-uploader-debug", "../common/attach-uploader/swfupload-config-debug", "../common/attach-uploader/attach-debug", "../common/attach-uploader/attach-list-view-debug", "../common/attach-uploader/attach-view-debug", "../common/textarea-pos-debug", "$-debug", "_-debug", "tab-debug", "gallery/modal/src/modal-debug", "backbone-debug", "swfupload-debug", "jquery-ujs-debug" ], function(require) {
    var $ = require("$-debug");
