 ...
 * blog 编辑表单
 */
define("klog/admin/blogs/form-debug", [ "../common/markdown-editor-debug", "../common/attach-uploader-debug", "../common/attach-uploader/swfupload-config-debug", "../common/attach-uploader/attach-debug", "../common/attach-uploader/attach-list-view-debug", "../common/attach-uploader/attach-view-debug", "../common/textarea-pos-debug", "_-debug", "$-debug", "tab-debug", "gallery/modal/src/modal-debug", "backbone-debug", "swfupload-debug", "jquery-ujs-debug" ], function(require) {
    var _ = require("_-debug");
    var $ = require("$-debug");
    ...
    var autoSave = {
        ...
        handleSwitch: function() {
            if (this.switcher.prop("checked")) {
                this.saveTimer = setInterval(this.save, 60 * 1e3);
            } else {
